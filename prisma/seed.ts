...
async function main() {
  ...
  await prisma.listing.create({
    data: {
      id: "listing-boing-1",
      title: "Spring Latch",
      description: "Native L1 study punched into Boing Testnet.",
      creatorId: fresh.id,
      type: "single",
      chain: "boing",
      network: "boing",
      ...
      priceUsd: 32,
      medium: "digital_ink",
      styleTagsJson: JSON.stringify(["boing", "paper"]),
      mediaHash: "boinglatch001hash0123456789abcdef",
      softLaunchedAt: new Date(now - 1 * day),
      risingEligibleAt: new Date(now - 12 * 60 * 60 * 1000),
      saves: 4,
      uniqueViewers: 18,
      dwellMsTotal: 14_000,
      impressionsToday: 36,
      impressionsThisWeek: 36,
    },
  });
