...
export function buildSeedState(): MarketplaceState {
  ...
  const roster: CreatorProfile[] = [
    ...
    creator({
      ...
      wallets: [
        { chain: "evm",
      network: "ethereum", address: "0xfresh00000000000000000000000000000001" },
        { chain: "boing",
      network: "boing", address: `0x${"aa".repeat(32)}` },
      ],
    }),
    creator({
      id: "collector-mira",
  ...
  const seedListings: Listing[] = [
    ...
    },
    {
      ...
      priceUsd: 32,
      medium: "digital_ink",
      styleTags: ["boing", "paper"],
      mediaHash: "boinglatch001hash0123456789abcd",
      metadataComplete: true,
      originalMedia: true,
      createdAt: now - 1 * day,
      softLaunchedAt: now - 1 * day,
      risingEligibleAt: now - 12 * 60 * 60 * 1000,
      featuredAt: null,
      oeStartsAt: null,
      oeEndsAt: null,
      auctionStartsAt: null,
